const zhCN: Record<string, string> = {
  ...
  "download.advEmbedSubsHelp": "将字幕混流进视频文件。需要 ffmpeg，仅视频。",
  "download.advSubLangsHelp": "要下载的语言代码，如 en,zh。'all' 表示全部。",
  "download.advConvertSubsHelp": "将下载的字幕转换为此格式。需要 ffmpeg。",
  "download.advSbModeHelp": "关闭、将赞助片段标记为章节，或剪掉(破坏性)。",
  "download.advSbCategoriesHelp": "SponsorBlock 处理的片段类型。",
  "download.advEmbedThumbnailHelp": "将缩略图嵌入为封面。需要 ffmpeg。",
  "download.advEmbedMetadataHelp": "将标题、艺术家、日期写入文件标签。需要 ffmpeg。",
  "download.advEmbedChaptersHelp": "为文件添加章节标记。需要 ffmpeg。",
  "download.advWriteThumbnailHelp": "将缩略图保存为单独的图片文件。",
  "download.advWriteInfoJsonHelp": "将完整元数据保存为 .info.json 文件。",
  "download.advVideoCodecHelp": "优先使用此视频编码。在 MKV/合并时效果最佳，MP4 可能忽略。",
  "download.advLimitRateHelp": "限制下载速度，如 1M 或 500K。",
  "download.advConcurrentFragmentsHelp": "并发下载这么多分片(1-16)。加速 DASH/HLS。",
  "download.advRetriesHelp": "出错时的重试次数(0-100)。留空为默认。",
  "download.advSleepIntervalHelp": "为避免限速，在下载之间等待这么多秒。",
  "download.advMergeFormatHelp": "合并独立视频和音频的容器。仅视频。",
  "download.advRemuxVideoHelp": "不重新编码，重新封装为此容器。需要 ffmpeg，仅视频。",
  "download.advDownloadSectionsHelp": "仅下载此时间范围，如 1:30-2:45。需要 ffmpeg。",
  "download.advSplitChaptersHelp": "按章节将视频分割为多个文件。需要 ffmpeg。",
  "download.advProxyHelp": "通过此代理下载，如 http://127.0.0.1:8080。",
  "download.advNoMtimeHelp": "不将文件修改时间设为视频上传日期。",
  "download.advRestrictFilenamesHelp": "文件名仅使用 ASCII 字符(无空格或 Unicode)。",
  ...
  "queue.cancelled": "已取消",
  "queue.retry": "重试",
  "queue.inProgress": "进行中",
  "queue.records": "记录",
  "queue.all": "全部",
  "queue.downloading": "下载中",
  "queue.pending": "等待",
  "queue.clearAll": "全部清除",
  "queue.clearAllConfirm": "删除整个队列和记录？此操作无法撤销。",
  ...
  "settings.ffmpegGplNotice": "Windows/Linux 的应用托管 FFmpeg 使用可再分发的 GPLv3 构建。macOS 使用系统 FFmpeg 或合规的内置 sidecar；许可文件包含在 third_party_licenses 中。",
